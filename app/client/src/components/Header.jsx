          ...
          <div style={{
            ...
            <Link
              ...
              style={{
                ...
                height: '40px',
                borderRadius: 'var(--radius-md)',
                background: isActiveLink('/search') ? 'var(--color-primary)' : 'transparent',
                color: isActiveLink('/search') ? 'white' : 'var(--color-text)',
                border: isActiveLink('/search') ? 'none' : '1px solid var(--color-border)',
                cursor: 'pointer',
                transition: 'var(--transition-default)',
                textDecoration: 'none'
              }}
